...
$connectionStringState = Format-ConnectionStringState
if ($connectionStringState -eq "SET BUT HAS PLACEHOLDERS") {
    $blockers.Add("CRM_1C_CONNECTION_STRING still has placeholder USER/PASSWORD values")
}
...
Write-Line "`$env:CRM_1C_CONNECTION_STRING = 'Srvr=""192.168.0.5"";Ref=""elista"";'"
Write-Line "powershell.exe -NoProfile -ExecutionPolicy Bypass -File '$ExportDir\run-1c-export-now.ps1'"
